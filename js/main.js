...
const randomAbilities = [

    {
        ...
        limit: "상대방과 의식적으로 시선을 맞춰야 발동 · 상대가 거짓을 말할 때만 발동",
        detail: "시선을 마주친 상대가 거짓을 말하면 자신의 동공색이 붉게 변하고 상대 동공에 X자 표식와 적안변화가 나타납니다. 단, 상대가 진실이라고 믿는 거짓말을 말할 때는 적안변화가 발동하지 않습니다.",
    ...
    },
    {
        ...
        backlash: "생성된 파티클은 별가루처럼 공중에 부유하며 한곳에 모으거나 넓게 퍼뜨릴 수 있습니다. 섬광 수준으로 사용할 경우 시전자도 일정 시간 시야를 잃으며 시간이 지나면 자연적으로 시야를 회복합니다. 시전자가 보이지 않는 상태라도 주변이 밝다면 새 파티클을 생성할 수 없습니다."
    },
    {
        type: "광휘계 ",
        name: "나 좀 지켜줘!",
